...
import type { ClusterMethodPayload, GenreAlignment, PsalmCore } from "../../../shared/model";
import {
  buildPoints,
...
//: Stand-ins for DOM nodes, since the check compares reference equality only.
function fakeNode(): EventTarget {
  return {} as EventTarget;
}

describe("degenerateHullCentroid", () => {
  //: The fallback for a cluster too small for a hull, whose area would be zero.
