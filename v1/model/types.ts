 ...
 * pipeline/src/tehillim/export_clustering.py */
...
export interface Embedding2D {
  ...
  /** The pre-rename name for the same quantity. Payloads generated before
   * `structureCaptured` replaced it carry only this, so both are read. */
...
/** Mirrors the JSON payload written by
 * pipeline/src/tehillim/export_gunkel.py - shared ground-truth
