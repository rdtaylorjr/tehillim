...
/** The Compare page's detail: this psalm's own facts, the terms that drive its
 * score under the current method, and its ranked closest matches. */
...
/** The Cluster page's counterpart: no ranked-by-score matches (clustering is a
 * partition, not a similarity ranking) - instead, every other psalm sharing
 * this psalm's cluster. */
